    ...
    return (
        <header className="flex justify-center items-center h-[4rem] w-full fixed bg-[#1b1a17] z-[999]">
            <div className={`flex justify-between w-full lg:w-[80%]`}>
                ...
                <button aria-label="burgermenu" type="button" className="menu-btn block lg:hidden pr-4 z-[999]" onClick={ handleClick }>
                    <div className={ clsx(``,
                            {
                                'block': !menu,
                                'hidden': menu   
                ...
                <ul className={clsx(`flex flex-col lg:flex-row justify-center items-center lg:justify-end fixed w-full lg:relative gap-4 text-[1.2rem] ${inconsolata.className} pt-[4rem] pb-[1rem] lg:pt-[1em]  bg-[#00000055] lg:bg-transparent`,
                {
                    'block': menu,
                    'hidden': !menu,
                    'lg:flex': menu || !menu,
