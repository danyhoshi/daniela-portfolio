    ...
    return (
        <header className="flex justify-center items-center fixed h-[4rem] md:h-[8rem] lg:h-[4rem] w-full bg-[#1b1a17] z-[888]">
            <div className={`flex justify-between w-full lg:max-w-[1000px] md:justify-center md:items-center md:flex-col lg:justify-between lg:flex-row`}>
                ...
                <div className={clsx(`absolute w-screen h-screen z-[890]`,
                            {
                                'block': menu,
                                'hidden': !menu 
                            })} onClick={ closeModal }></div>
                <ul className={clsx(`flex flex-col lg:flex-row justify-center items-center lg:justify-end fixed z-[899] w-full lg:relative gap-4 text-[1.2rem] ${inconsolata.className} font-bold mt-[4rem] pt-8 md:mt-0 lg:mt-0 pb-[1rem] lg:pt-[1em] bg-[#000000dd] lg:bg-transparent md:bg-transparent md:justify-evenly md:pt-[6rem]`,
                {
                    'block': menu,
                    'hidden': !menu,
                    'lg:flex': menu || !menu,
                    ...
                    <Link href="/"><li onClick={handleClick}>Home</li></Link>
                    <Link href="/about-me"><li onClick={handleClick}>About Me</li></Link>
                    <Link href="/skills"><li onClick={handleClick}>Skills</li></Link>
                    <Link href="/pet-projects"><li onClick={handleClick}>Pet-Projects</li></Link>
                    <Link href="/contacts"><li onClick={handleClick}>Contacts</li></Link>
                </ul>   
