...
export default function Header() {
    ...
    return (
        <header className="flex justify-center items-center h-[4rem] w-full fixed bg-[#1b1a17] z-[999]">
            <div className={`flex justify-between w-full lg:w-[80%] md:justify-center md:items-center md:flex-col lg:justify-between lg:flex-row`}>
                <div className={`text-[2.2rem] ${anton.className} pl-4`}>
                ...
                <ul className={clsx(`flex flex-col lg:flex-row justify-center items-center lg:justify-end fixed w-full lg:relative gap-4 text-[1.2rem] ${inconsolata.className} pt-[4rem] pb-[1rem] lg:pt-[1em]  bg-[#00000055] lg:bg-transparent md:bg-transparent md:justify-evenly md:pt-[6rem]`,
                {
                    'block': menu,
                    'hidden': !menu,
                    'lg:flex': menu || !menu,
                    ...
                    <Link href=""><li>Pet-Projects</li></Link>
